...
> **Added v2.1 (2026-03-19).** Required for contract-track projects targeting publication. Prevents single-source label bias. (LL-90)

### Label Sources

| Source | Type | Count | Known Lag | Positive Rate | Limitations |
|--------|------|-------|-----------|---------------|-------------|
| {{LABEL_SOURCE_1}} | {{TYPE_1}} | {{COUNT_1}} | {{LAG_1}} | {{RATE_1}} | {{LIMITS_1}} |

### Alternative Sources Considered

| Source | Included? | Rationale |
|--------|-----------|-----------|
| {{ALT_SOURCE_1}} | YES / NO | {{RATIONALE_1}} |

> **Self-test:** If your only label source has a systematic bias, how would you know? A second source is the check.
