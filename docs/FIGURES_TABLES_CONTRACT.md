...
> **Upstream:** EXPERIMENT_CONTRACT (per-run output schemas), METRICS_CONTRACT (summary table interface)
> **Downstream:** REPORT_ASSEMBLY_PLAN (figure/table placement), EXECUTION_MANIFEST (artifact-to-report-section mappings), SCRIPT_ENTRYPOINTS_SPEC (artifact generation scripts)
