...
This contract defines the hypothesis pre-registration protocol for the **{{PROJECT_NAME}}** project. It ensures that testable predictions are formulated **before** experiments begin, grounded in EDA evidence and ML theory, preventing post-hoc rationalization.
